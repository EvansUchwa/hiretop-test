...
const jobJoiSchema = Joi.object({
    ...
    jobType: Joi.string().required().valid(...jobTypeEnum), // Remplacez les valeurs par celles que vous utilisez

    requiredDegree: Joi.string().required().valid(...degreeEnum), // Remplacez les valeurs par celles que vous utilisez
    requiredExpYear: Joi.string().required().valid(...expYearsEnum), // Remplacez les valeurs par celles que vous utilisez
